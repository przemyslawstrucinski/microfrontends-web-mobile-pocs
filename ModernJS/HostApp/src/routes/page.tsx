...
// Dynamically import the SearchWidget from the Search MFE using Module Federation
const SearchWidget = lazy(() => import('search_mfe/SearchWidget'));
    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-primary-100">Book appointments with verified healthcare professionals across Poland</p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Why Choose nowoczesnylekarz?</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">All doctors are verified and certified healthcare professionals</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Read genuine reviews from verified patients</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Popular Specialties</h2>
      ...
      <section className="bg-primary-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-primary-100">Join thousands of patients who trust nowoczesnylekarz</p>
          <a
            href="/search"
