          ...
          {filteredDoctors.length > 0 ? (
            <>
              {filteredDoctors.map((doctor: Doctor) => (
                <div key={doctor.id} className="border border-gray-200 rounded-lg p-4 hover:border-primary-500 transition-colors">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        <span className="text-sm text-gray-600">{doctor.rating} ({doctor.reviews})</span>
                      </div>
                    </div>
                    <a
              ...
              <a
                ...
                onClick={(e) => {
                  ...
                  // Navigate parent window if in iframe, otherwise current window
                  const targetWindow = window.self !== window.top ? window.parent : window;
                  targetWindow.location.href = '/search';
                }}
            ...
            <p className="text-center text-gray-500 py-4">No doctors found. Try different criteria.</p>
          )}
        </div>
      )}
    </div>
